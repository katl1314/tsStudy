...
console.log(toArray<number>(1, 2)); // [1, 2]
// console.log(toArray<number>(1, "2")); // 에러 발생 배열 요소는 오직 number타입만 허용함.
console.log(toArray<string>("Typescript", "Javascript")); // ["Typescript", "Javascript"]
console.log(toArray<string | number>("Typescript", 1)); // ["Typescript", 1] (유니온 타입 두 타입 모두 지원)

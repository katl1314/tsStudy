...
namespace DeclareMerge {
    ...
    export function animalIsHaveMuscles() {
...
namespace DeclareMerge {
    ...
    export function doAnimalHaveMuscle() {
        return this.hasMuscles;
    }
    /**
     * interface cloner {
...
const myBox: DeclareMerge.Box = {
    width: 10,
    height: 20,
};

const myCloner: DeclareMerge.cloner = {
    clone: function (animal: Animal): Animal {
        return animal;
    },
};
